export const diseases = [
  ...
  { name: "Gastroenteritis", solutions: ["Apple cider vinegar: this helps ease nausea and stomach upset. ",] },
  ...
  { name: "hepatitis A", solutions: ["Silymarin. This extract of the milk thistle plant is the most popular herbal remedy for hepatitis C.it can be used to bring down inflammation and remove toxins from the liver. ",
...
"Alcohol can speed up the progression of hepatitis types, so consider eliminating it from your diet.",] },
  { name: "Hepatitis B", solutions: ["Silymarin. This extract of the milk thistle plant is the most popular herbal remedy for hepatitis C.it can be used to bring down inflammation and remove toxins from the liver. ",
"The condition can heal on its own given time and symptom severity.",
"Zinc supplements are sometimes touted as a good therapy for hepatitis",
"Alcohol can speed up the progression of hepatitis types, so consider eliminating it from your diet.",] },
  { name: "Hepatitis C", solutions: ["Silymarin. This extract of the milk thistle plant is the most popular herbal remedy for hepatitis C.it can be used to bring down inflammation and remove toxins from the liver. ",
"The condition can heal on its own given time and symptom severity.",
"Zinc supplements are sometimes touted as a good therapy for hepatitis",
"Alcohol can speed up the progression of hepatitis types, so consider eliminating it from your diet.",] },
  { name: "Hepatitis D", solutions: ["Silymarin. This extract of the milk thistle plant is the most popular herbal remedy for hepatitis C.it can be used to bring down inflammation and remove toxins from the liver. ",
"The condition can heal on its own given time and symptom severity.",
"Zinc supplements are sometimes touted as a good therapy for hepatitis",
"Alcohol can speed up the progression of hepatitis types, so consider eliminating it from your diet.",] },
  { name: "Hepatitis E", solutions: ["Silymarin. This extract of the milk thistle plant is the most popular herbal remedy for hepatitis C.it can be used to bring down inflammation and remove toxins from the liver. ",
"The condition can heal on its own given time and symptom severity.",
"Zinc supplements are sometimes touted as a good therapy for hepatitis",
"Alcohol can speed up the progression of hepatitis types, so consider eliminating it from your diet.",] },
  { name: "Alcoholic hepatitis", solutions: ["try integrating moderate physical activity into your daily routine.",
...
"Try to limit your intake of certain types of fats to help control your cholesterol",] },
  { name: "Tuberculosis", solutions: ["Chew two or three buds of garlic every morning for a month as garlic contain sulfuric acid which helps fight the tuberculosis bacteria. It has antimicrobial Properties and can also boost your immune system.",
...
"Eat Fruits rich in vitamin A, E, and C like orange, mango, papaya",] },
  { name: "Common Cold", solutions: ["Hydration:When you're hydrated, your body has a natural ability to flush germs out of your system.",
...
"Using a netipot can help relieve stuffiness and congestion.",] },
  { name: "Pneumonia", solutions: ["It is recommended to go seek professional medical care.",
